use crate::{
    dataset::{LabelSet, ValueKey, ValueLabel, ValueType},
    error::{Error, Result, Section},
    parser::{
        core::{
            byteorder::{read_u16, read_u32, read_u64, read_u64_be},
            encoding::{resolve_encoding, trim_trailing},
            float_utils::try_int_from_f64,
        },
